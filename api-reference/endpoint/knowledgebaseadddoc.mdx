...
Add a document to an existing [knowledge base](/docs/agents/knowledge/overview). Supported formats: **PDF**, **DOCX**, **DOC**, **TXT**, **PPTX**, **PNG**, **JPG**, **JPEG**, **MD**, **JSON**, plain text, and URLs (single page or full site crawl).

## Supported inputs

| Input | Content-Type | Notes |
| --- | --- | --- |
| Document file (`.pdf`, `.docx`, `.doc`, `.txt`, `.pptx`, `.png`, `.jpg`, `.jpeg`, `.md`, `.json`) | `multipart/form-data` | Best for policies, manuals, images, structured content |
