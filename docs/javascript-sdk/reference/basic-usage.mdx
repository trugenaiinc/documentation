...
To keep your API key secure, exchange it for a short-lived session token on your server before initializing the client. See [Usage in Production](/docs/javascript-sdk/production) for detailed session token information.
