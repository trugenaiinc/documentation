...
Once your server creates and returns the session token, pass it to your client application to initialize the SDK and start streaming. See the [Quickstart](/docs/javascript-sdk/quickstart) and [Basic Usage](/docs/javascript-sdk/reference/basic-usage) guides for client-side integration examples.
