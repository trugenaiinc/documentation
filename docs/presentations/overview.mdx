...
| **PowerPoint** | `.pptx` | 100 MB | Upload a file or provide a public URL. Each slide is indexed. |
...
<CardGroup cols={2}>
  <Card title="Creating a Presentation" icon="plus" href="/docs/presentations/creating">
    Create your first presentation in the Studio or via the API.
  </Card>
  <Card title="Attaching to Agents" icon="link" href="/docs/presentations/attaching">
    Wire your presentations to one or many agents.
  </Card>
</CardGroup>
