...
| **Vision Awareness** | Hawkeye-2 continuously reads gestures, gaze, and body language to feed real-world context into responses |
...
| **Vision** | Gesture, gaze, and body language via Hawkeye-2 |
| **Avatar Rendering** | Expressive lip-sync, micro-expressions, and emotional nuance via Huma-3 |
