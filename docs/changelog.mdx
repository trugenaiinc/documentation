...
---
<Update label="2026-05-28" description="v0.5.0">
Introducing Make.com and N8N workflow support

### Key Features in This Release

- **Make.com workflows:** We are announcing that our official app is published in Make.com app directory.
- **n8n workflows:** We are introducing support for n8n nodes.
